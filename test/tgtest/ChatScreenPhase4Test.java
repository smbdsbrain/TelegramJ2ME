...
public final class ChatScreenPhase4Test implements Test
{
    ...
    public void run()
    {
        DeviceFactory.setDevice(new FontDevice());
    ...
    private static final class FontDevice implements Device
    {
        ...
        {
            fonts.init();
            screen.setDisplayRectangle(new Rectangle(0, 0, 320, 240));
            screen.setDisplayPaintable(new Rectangle(0, 0, 320, 240));
