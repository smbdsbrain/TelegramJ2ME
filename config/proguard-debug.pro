...
#
# Exactly one handset has ever run this client, so a report that names a real
# class is worth more than the kilobytes optimisation would save. Release builds
# drop this file and take the smaller JAR instead - see docs/releasing.md.
